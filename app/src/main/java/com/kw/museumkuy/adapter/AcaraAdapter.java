...
public class AcaraAdapter extends BaseAdapter {
    // params
    List<AcaraModel> listItem;
    Activity activity;

    public AcaraAdapter(Activity activity, List<AcaraModel> listItem){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AcaraModel model = (AcaraModel) getItem(position);
        holder.txtTitle.setText(model.getNamaAcara());
        holder.txtDesc.setText(model.getFasilitasWisata());
        holder.txtAlamat.setText(model.getTanggal());
